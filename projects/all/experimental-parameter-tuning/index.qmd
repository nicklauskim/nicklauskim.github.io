---
title: Hyperparameter Tuning for Gradient Boosting Frameworks Using Statistical Experimental Design (in progress)
description: "Applying Advanced Experimental Designs to Optimization of Hyperparameters in XGBoost"
date: 2025-07-15
categories: [statistics, bayesian, optimization, Gaussian processes, experimental design, machine learning, R]
image: "images/test_tubes.webp"
---

Here is a link to a written report for this project:
<iframe src="./final_project.pdf" width="100%" height="600px">
  This browser does not support PDFs. Please download the PDF to view it: 
  <a href="./final_project.pdf">Download PDF</a>.
</iframe>

The rest of this page below contains more detailed notes on the background information behind this project and a condensed overview of my code results and analysis.

::: {.callout-note collapse="false"}
##  Notes on Background and Methodology
