...
We apply this approach to a regression problem found in a computational research paper published in a materials sciences journal, comparing their methodology and final model results to that of our analysis. In this paper, the authors use a common method: XGBoost (Chen et al. 2016). For a quick description of the model parameters see (Chen et al. 2018a). In addition, we show the results of using our methodology to tune the hyperparameters of XGBoost models on a common benchmark ML dataset to compare the effectiveness of our hyperparameter choices versus well-known baseline performance levels.
