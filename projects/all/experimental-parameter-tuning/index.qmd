...
date: 2025-05-10
categories: [statistics, bayesian, experimental design, optimization]
image: "images/test_tubes.webp"
---


## Introduction/Background
Experimental design is a crucial part of any statistical experiment. This includes computer simulations, where we develop some predictive model trained on a real dataset. 
...
To explore the eﬀects of eﬃcient experimental design on the outcome of a computer experiment, we examine the use of advanced experimental designs such as Latin Hypercube Sampling (LHS) and Maximum Projection Designs.
